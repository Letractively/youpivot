...
main () {
                ...
                dir_to_path '/Users/dustin/work/dev/couch/release/build/lib' 'insert' 'DYLD_LIBRARY_PATH'
            
        
    
        
            
                dir_to_path '/Users/dustin/work/dev/couch/release/build/bin' 'insert' 'PATH'
