...
main () {
                ...
                dir_to_path '/Users/dustin/work/dev/couch/preview/build/lib' 'insert' 'DYLD_LIBRARY_PATH'
            
        
    
        
            
                dir_to_path '/Users/dustin/work/dev/couch/preview/build/bin' 'insert' 'PATH'
