...
$(window).load(function(){ 
	...
	debugItems[debugItems.length] = {title: "Crabby", url: "", keywords: ["Holy", "Crap"], startTime: new Date().getTime()-22*60*60000, endTime: new Date().getTime()-22*60*60000+1, events: [], domain: crap};
